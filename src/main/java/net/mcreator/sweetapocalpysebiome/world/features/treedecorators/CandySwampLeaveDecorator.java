...
@EventBusSubscriber
public class CandySwampLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<CandySwampLeaveDecorator> CODEC = MapCodec.unit(CandySwampLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sweetapocalpysebiome:candy_swamp_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public CandySwampLeaveDecorator() {
		super(0.25f);
	}
