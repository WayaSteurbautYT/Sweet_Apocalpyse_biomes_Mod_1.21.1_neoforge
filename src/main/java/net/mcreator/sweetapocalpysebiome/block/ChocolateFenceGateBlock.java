...
public class ChocolateFenceGateBlock extends FenceGateBlock {
	@SuppressWarnings("null")
	public ChocolateFenceGateBlock() {
		super(WoodType.OAK, BlockBehaviour.Properties.of().sound(SoundType.WOOD).strength(6f, 9f).ignitedByLava().instrument(NoteBlockInstrument.BASS).forceSolidOn());
	}
